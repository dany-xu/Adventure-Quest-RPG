...
public class Priest extends Role {
    ...
    public Priest(String name, Double HP) {
        super(name, HP, 15, 5, 5, 10, 5, "Heal");
    }
    ...
    /**
     * Use skill to heal the priest.
     * The priest heals up to 30 HP but cannot exceed a maximum of 100 HP.
     */
